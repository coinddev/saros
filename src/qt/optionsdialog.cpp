    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("SAROS-light"), QVariant("light"));
    ui->theme->addItem(QString("SAROS-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("SAROS-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("SAROS-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("SAROS-traditional"), QVariant("trad"));

    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Saros Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Saros address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and saros: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Saros Core"), this);
    aboutAction->setStatusTip(tr("Show information about Saros Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Saros Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Saros addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Saros addresses"));
    ...
    openAction->setStatusTip(tr("Open a saros: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Saros Core help message to get a list with possible Saros Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Saros Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Saros network", "", count));
    } else {
...
{
    QString strTitle = tr("Saros Core"); // default title

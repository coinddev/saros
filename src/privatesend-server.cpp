...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Saros related functionality
...
/*
    ...
    allow endless transaction that would bloat Saros and make it unusable. To
